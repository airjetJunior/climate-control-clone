          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3 text-sm">
                ...
                <a href="mailto:junior@airjetclimatizacao.com.br" className="text-primary-foreground/70 hover:text-primary transition-colors">
                  junior@airjetclimatizacao.com.br
                </a>
              </li>
              <li className="flex items-center gap-3 text-sm">
